...
//	D. 멤버 저장
	...
	String author; //멤버변수(필드) //"생텍쥐베리"  //"작자미상"
...
//		A. 매개변수 가지고 생성자 호출
		...
		System.out.println(littlePrince.title+" "+littlePrince.author); //(객체.멤버)
		System.out.println(loveStory.title+" "+loveStory.author); //(객체.멤버)
